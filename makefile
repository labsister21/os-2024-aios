...
iso: kernel
	...
	@genisoimage -R -b boot/grub/grub1 -no-emul-boot -boot-load-size 4 -A aiOS -input-charset utf8 -quiet -boot-info-table -o $(OUTPUT_FOLDER)/OS2024.iso $(OUTPUT_FOLDER)/iso/
